...
- Change the Character into a assymetrical character (triangle) in orderr to allow better control by player (Complete)
- Make the boundaries looping for Enemies and PLayer, but not bullets to keep bullet count down (Complete)
- Create a shoot function to fire rectangles using the player current position and direction  (Complete)
